            ...
            <div className='text-bg'>
                ...
                <div className='body'>
                    <div style={{ "display": "block", "textAlign": "left", "marginLeft": "25px", "padding": "5px" }}>
                        <br />
                        <a style={{ color: 'white', "margin": "0px" }} href={card.map}>
                            <div className="group">
                                <p className='tl2' style={{ color: 'white', "margin": "0px" }}><i style={{ "textAlign": "left" }} className="fad fa-map-marker-alt fa-2x"></i> &nbsp;{card.address}</p>
                            </div>
                        </a>
                        <br />
                        <a style={{ color: 'white', "margin": "0px" }} href={'tel:' + card.phone}>
                            <div className="group">
                                <i style={{ "textAlign": "left" }} className="fad fa-phone fa-2x"></i> &nbsp;
                                <p className='tl2' style={{ color: 'white', "margin": "0px" }}>{card.phone}</p>
                            </div>
                        </a>
                        <br />
                        <a style={{ color: 'white', "margin": "0px" }} href={'mailto:' + card.email}>
                            <div className="group">
                                <i style={{ "textAlign": "left" }} className="fad fa-envelope fa-2x"></i> &nbsp;
                                <p className='tl2' style={{ color: 'white', "margin": "0px" }}>{card.email}</p>
                            </div>
                        </a>
                        <br />
                        {
                            card.website
                            ? <a style={{ color: 'white', "marginBottom": "10px" }} href={card.website}>
                                <div className="group">
                                    <i style={{ "textAlign": "left" }} className="fal fa-globe fa-2x"></i> &nbsp;
                                    <p className='tl2' style={{ "margin": "0px" }}>{card.website.replace(/(^\w+:|^)\/\//, '')}</p>
                                </div>
                            </a>
                            : ''
                        }
